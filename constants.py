...
# attempt working only with __dict__present, see function below for an implementation
# which works off the attribute list
# def add_lookup(cls):
...
@add_lookup
class MODE:
    SLEEP    = 0x80   #these modes enforce LoRa with bit 7 set
    STDBY    = 0x81
    FSTX     = 0x82
    TX       = 0x83
    FSRX     = 0x84
